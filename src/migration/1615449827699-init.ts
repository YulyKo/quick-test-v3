...
export class init1615449827699 implements MigrationInterface {
    name = 'init1615449827699'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "test" ADD CONSTRAINT "FK_394889f330e608a61edd1163cdf" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "test" ADD CONSTRAINT "FK_0553e0c9af924579f1825a1987e" FOREIGN KEY ("folderId") REFERENCES "folders"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "test_questions_questions" ADD CONSTRAINT "FK_80942d30d72b7c1f1b4ee5442fb" FOREIGN KEY ("testId") REFERENCES "test"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "test_questions_questions" ADD CONSTRAINT "FK_eec101181752c792bc3c326b9f8" FOREIGN KEY ("questionsId") REFERENCES "questions"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "test_questions_questions" DROP CONSTRAINT "FK_eec101181752c792bc3c326b9f8"`);
        await queryRunner.query(`ALTER TABLE "test_questions_questions" DROP CONSTRAINT "FK_80942d30d72b7c1f1b4ee5442fb"`);
        ...
        await queryRunner.query(`ALTER TABLE "test" DROP CONSTRAINT "FK_0553e0c9af924579f1825a1987e"`);
