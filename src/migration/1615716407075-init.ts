...
export class init1615716407075 implements MigrationInterface {
  name = 'init1615716407075';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "users" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "email" character varying NOT NULL, "name" character varying NOT NULL, "hash" character varying NOT NULL, "refreshToken" character varying DEFAULT null, CONSTRAINT "PK_a3ffb1c0c8416b9fc6f907b7433" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "tests_questions_questions" ("testsId" uuid NOT NULL, "questionsId" uuid NOT NULL, CONSTRAINT "PK_3887634f2a7fc0b2ffef4c368aa" PRIMARY KEY ("testsId", "questionsId"))`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_ed351025b10093152444092ee3" ON "tests_questions_questions" ("testsId") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_4892586e1ed4dbf632b4597857" ON "tests_questions_questions" ("questionsId") `,
    );
    await queryRunner.query(
      `ALTER TABLE "tests" ADD CONSTRAINT "FK_9b4193834978a419a4d477940da" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "tests" ADD CONSTRAINT "FK_7f102b3e4e99b2f433c2beaf1ab" FOREIGN KEY ("folderId") REFERENCES "folders"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "tests_questions_questions" ADD CONSTRAINT "FK_ed351025b10093152444092ee3c" FOREIGN KEY ("testsId") REFERENCES "tests"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "tests_questions_questions" ADD CONSTRAINT "FK_4892586e1ed4dbf632b45978573" FOREIGN KEY ("questionsId") REFERENCES "questions"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "tests_questions_questions" DROP CONSTRAINT "FK_4892586e1ed4dbf632b45978573"`,
    );
    await queryRunner.query(
      `ALTER TABLE "tests_questions_questions" DROP CONSTRAINT "FK_ed351025b10093152444092ee3c"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "tests" DROP CONSTRAINT "FK_7f102b3e4e99b2f433c2beaf1ab"`,
    );
    await queryRunner.query(
